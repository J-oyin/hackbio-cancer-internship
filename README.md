...
Code link: 
https://hackbiointern-leo4437.slack.com/archives/C07MU3KVD36/p1727349814682329
Introduction
...
Fig 2 shows genes expressed in tumor tissue compared to normal tissue  
 
Figure 2: Volcano plots of differentially expressed genes
Fig 3&4 are the results of the functional enrichment analysis, which revealed key important pathways that are implicated by the upregulated and downregulated genes, with the top four significant pathways highlighted.
  
Figure 3: Enrichment analysis of upregulated genes

 
Figure 4: Enrichment analysis of downregulated genes
Fig 5&6 shows the KEGG enrichment analysis results. The size of the dot correlatse to the degree of impact. The interaction and impact of some of the implicated pathways have been reported in several literatures (Zhang et al., 2023; Gao et al., 2024). 
